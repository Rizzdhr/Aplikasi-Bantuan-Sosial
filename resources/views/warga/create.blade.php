                ...
                <div class="p-6 bg-white border-b border-gray-200 space-y-6">
                    ...
                    <form action="{{ route('warga.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            ...
                            <div>
                                <label for="gol_darah" class="block text-sm font-medium text-gray-700">Golongan
                                    Darah</label>
                            ...
                            <div>
                                <label for="penghasilan"
                                    class="block text-sm font-medium text-gray-700">Penghasilan</label>
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            ...
                            <div>
                                <label for="status_pernikahan" class="block text-sm font-medium text-gray-700">Status
                                    Pernikahan</label>
                                ...
                                <select id="pekerjaan" name="pekerjaan"
                                    ...
                                    <optgroup label="Tidak/Belum Bekerja">
                                        ...
                                        <option value="IBU RUMAH TANGGA"
                                            {{ old('pekerjaan') == 'IBU RUMAH TANGGA' ? 'selected' : '' }}>Ibu Rumah
                                            Tangga</option>
                                    ...
                                    <optgroup label="Buruh / Pekerja Harian">
                                        <option value="BURUH HARIAN LEPAS"
                                            {{ old('pekerjaan') == 'BURUH HARIAN LEPAS' ? 'selected' : '' }}>Buruh
                                            Harian Lepas</option>
                                        <option value="BURUH TANI/PERKEBUNAN"
                                            {{ old('pekerjaan') == 'BURUH TANI/PERKEBUNAN' ? 'selected' : '' }}>Buruh
                                            Tani/Perkebunan</option>
                                        <option value="BURUH NELAYAN/PERIKANAN"
                                            {{ old('pekerjaan') == 'BURUH NELAYAN/PERIKANAN' ? 'selected' : '' }}>Buruh
                                            Nelayan/Perikanan</option>
                                        <option value="PETANI/PEKEBUN"
                                            {{ old('pekerjaan') == 'PETANI/PEKEBUN' ? 'selected' : '' }}>Petani/Pekebun
                                        </option>
                                        <option value="NELAYAN/PERIKANAN"
                                            {{ old('pekerjaan') == 'NELAYAN/PERIKANAN' ? 'selected' : '' }}>
                                            Nelayan/Perikanan</option>
                                        <option value="PETERNAK"
                                            {{ old('pekerjaan') == 'PETERNAK' ? 'selected' : '' }}>Peternak</option>
                                        <option value="TUKANG BATU"
                                            {{ old('pekerjaan') == 'TUKANG BATU' ? 'selected' : '' }}>Tukang Batu
                                        </option>
                                        <option value="TUKANG KAYU"
                                            {{ old('pekerjaan') == 'TUKANG KAYU' ? 'selected' : '' }}>Tukang Kayu
                                        </option>
                                        <option value="TUKANG OJEK"
                                            {{ old('pekerjaan') == 'TUKANG OJEK' ? 'selected' : '' }}>Tukang Ojek
                                        </option>
                                        <option value="TUKANG LISTRIK"
                                            {{ old('pekerjaan') == 'TUKANG LISTRIK' ? 'selected' : '' }}>Tukang Listrik
                                        </option>
                                        <option value="TUKANG JAHIT"
                                            {{ old('pekerjaan') == 'TUKANG JAHIT' ? 'selected' : '' }}>Tukang Jahit
                                        </option>
                                        <option value="TUKANG LAS/PANDAI BESI"
                                            {{ old('pekerjaan') == 'TUKANG LAS/PANDAI BESI' ? 'selected' : '' }}>Tukang
                                            Las/Pandai Besi</option>
                                        <option value="TUKANG CUKUR"
                                            {{ old('pekerjaan') == 'TUKANG CUKUR' ? 'selected' : '' }}>Tukang Cukur
                                        </option>
                                        <option value="TUKANG GIGI"
                                            {{ old('pekerjaan') == 'TUKANG GIGI' ? 'selected' : '' }}>Tukang Gigi
                                        </option>
                                        <option value="MEKANIK" {{ old('pekerjaan') == 'MEKANIK' ? 'selected' : '' }}>
                                            Mekanik</option>
                                        <option value="PEMBANTU RUMAH TANGGA"
                                            {{ old('pekerjaan') == 'PEMBANTU RUMAH TANGGA' ? 'selected' : '' }}>
                                            Pembantu Rumah Tangga</option>
                                    </optgroup>

                                    <optgroup label="Pegawai / Karyawan">
                                        <option value="KARYAWAN SWASTA"
                                            {{ old('pekerjaan') == 'KARYAWAN SWASTA' ? 'selected' : '' }}>Karyawan
                                            Swasta</option>
                                        <option value="KARYAWAN BUMN"
                                            {{ old('pekerjaan') == 'KARYAWAN BUMN' ? 'selected' : '' }}>Karyawan BUMN
                                        </option>
                                        <option value="KARYAWAN BUMD"
                                            {{ old('pekerjaan') == 'KARYAWAN BUMD' ? 'selected' : '' }}>Karyawan BUMD
                                        </option>
                                        <option value="KARYAWAN HONORER"
                                            {{ old('pekerjaan') == 'KARYAWAN HONORER' ? 'selected' : '' }}>Karyawan
                                            Honorer</option>
                                        <option value="PEGAWAI NEGERI"
                                            {{ old('pekerjaan') == 'PEGAWAI NEGERI' ? 'selected' : '' }}>Pegawai Negeri
                                        </option>
                                        <option value="PEGAWAI SWASTA"
                                            {{ old('pekerjaan') == 'PEGAWAI SWASTA' ? 'selected' : '' }}>Pegawai Swasta
                                        </option>
                                        <option value="TENTARA NASIONAL INDONESIA"
                                            {{ old('pekerjaan') == 'TENTARA NASIONAL INDONESIA' ? 'selected' : '' }}>
                                            Tentara Nasional Indonesia</option>
                                        <option value="KEPOLISIAN RI"
                                            {{ old('pekerjaan') == 'KEPOLISIAN RI' ? 'selected' : '' }}>Kepolisian RI
                                        </option>
                                        <option value="WIRASWASTA"
                                            {{ old('pekerjaan') == 'WIRASWASTA' ? 'selected' : '' }}>Wiraswasta
                                        </option>
                                        <option value="PERDAGANGAN"
                                            {{ old('pekerjaan') == 'PERDAGANGAN' ? 'selected' : '' }}>Perdagangan
                                        </option>
                                        <option value="TRANSPORTASI"
                                            {{ old('pekerjaan') == 'TRANSPORTASI' ? 'selected' : '' }}>Transportasi
                                        </option>
                                        <option value="INDUSTRI"
                                            {{ old('pekerjaan') == 'INDUSTRI' ? 'selected' : '' }}>Industri</option>
                                        <option value="KONSTRUKSI"
                                            {{ old('pekerjaan') == 'KONSTRUKSI' ? 'selected' : '' }}>Konstruksi
                                        </option>
                                    ...
                                    <optgroup label="Profesional / Tenaga Ahli">
                                        ...
                                        <option value="DOKTER GIGI"
                                            {{ old('pekerjaan') == 'DOKTER GIGI' ? 'selected' : '' }}>Dokter Gigi
                                        </option>
                                        <option value="BIDAN" {{ old('pekerjaan') == 'BIDAN' ? 'selected' : '' }}>
                                            Bidan</option>
                                        <option value="PERAWAT" {{ old('pekerjaan') == 'PERAWAT' ? 'selected' : '' }}>
                                            Perawat</option>
                                        <option value="APOTEKER"
                                            {{ old('pekerjaan') == 'APOTEKER' ? 'selected' : '' }}>Apoteker</option>
                                        <option value="PSIKIATER/PSIKOLOG"
                                            {{ old('pekerjaan') == 'PSIKIATER/PSIKOLOG' ? 'selected' : '' }}>
                                            Psikiater/Psikolog</option>
                                        <option value="GURU/DOSEN"
                                            {{ old('pekerjaan') == 'GURU/DOSEN' ? 'selected' : '' }}>Guru/Dosen
                                        </option>
                                        <option value="PENGACARA"
                                            {{ old('pekerjaan') == 'PENGACARA' ? 'selected' : '' }}>Pengacara</option>
                                        <option value="NOTARIS" {{ old('pekerjaan') == 'NOTARIS' ? 'selected' : '' }}>
                                            Notaris</option>
                                        <option value="AKUNTAN" {{ old('pekerjaan') == 'AKUNTAN' ? 'selected' : '' }}>
                                            Akuntan</option>
                                        <option value="KONSULTAN"
                                            {{ old('pekerjaan') == 'KONSULTAN' ? 'selected' : '' }}>Konsultan</option>
                                        <option value="WARTAWAN"
                                            {{ old('pekerjaan') == 'WARTAWAN' ? 'selected' : '' }}>Wartawan</option>
                                        <option value="SENIMAN" {{ old('pekerjaan') == 'SENIMAN' ? 'selected' : '' }}>
                                            Seniman</option>
                                        <option value="USTADZ/MUBALIGH"
                                            {{ old('pekerjaan') == 'USTADZ/MUBALIGH' ? 'selected' : '' }}>
                                            Ustadz/Mubaligh</option>
                                        <option value="PASTOR" {{ old('pekerjaan') == 'PASTOR' ? 'selected' : '' }}>
                                            Pastor</option>
                                        <option value="PENDETA" {{ old('pekerjaan') == 'PENDETA' ? 'selected' : '' }}>
                                            Pendeta</option>
                                        <option value="POLITIKUS"
                                            {{ old('pekerjaan') == 'POLITIKUS' ? 'selected' : '' }}>Politikus</option>
                                        <option value="ANGGOTA DPR-RI"
                                            {{ old('pekerjaan') == 'ANGGOTA DPR-RI' ? 'selected' : '' }}>Anggota DPR-RI
                                        </option>
                                        <option value="ANGGOTA DPRD"
                                            {{ old('pekerjaan') == 'ANGGOTA DPRD' ? 'selected' : '' }}>Anggota DPRD
                                        </option>
                                        <option value="KEPALA DESA"
                                            {{ old('pekerjaan') == 'KEPALA DESA' ? 'selected' : '' }}>Kepala Desa
                                        </option>
                                        <option value="PERANGKAT DESA"
                                            {{ old('pekerjaan') == 'PERANGKAT DESA' ? 'selected' : '' }}>Perangkat Desa
                                        </option>
                                        <option value="PELAUT" {{ old('pekerjaan') == 'PELAUT' ? 'selected' : '' }}>
                                            Pelaut</option>
                                        <option value="PILOT" {{ old('pekerjaan') == 'PILOT' ? 'selected' : '' }}>
                                            Pilot</option>
                                    </optgroup>

                                    <optgroup label="Pengusaha / Pejabat Tinggi">
                                        <option value="PENELITI"
                                            {{ old('pekerjaan') == 'PENELITI' ? 'selected' : '' }}>Peneliti</option>
                                        <option value="PEJABAT NEGARA"
                                            {{ old('pekerjaan') == 'PEJABAT NEGARA' ? 'selected' : '' }}>Pejabat Negara
                                        </option>
                                        <option value="ANGGOTA BPK"
                                            {{ old('pekerjaan') == 'ANGGOTA BPK' ? 'selected' : '' }}>Anggota BPK
                                        </option>
                                        <option value="DUTA BESAR"
                                            {{ old('pekerjaan') == 'DUTA BESAR' ? 'selected' : '' }}>Duta Besar
                                        </option>
                                        <option value="GUBERNUR"
                                            {{ old('pekerjaan') == 'GUBERNUR' ? 'selected' : '' }}>Gubernur</option>
                                        <option value="BUPATI/WALIKOTA"
                                            {{ old('pekerjaan') == 'BUPATI/WALIKOTA' ? 'selected' : '' }}>
                                            Bupati/Walikota</option>
                                    </optgroup>
                                </select>
                                @error('pekerjaan')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
